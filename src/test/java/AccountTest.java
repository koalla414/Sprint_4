...
public AccountTest(String name, boolean expected) {
    ...
    public static Object[][] checkNameToEmboss() {
        return new Object[][]{
                ...
                {"ТимотиШаламе", false}, //меньше 1 пробела между словами
                {"Тимоти  Шаламе", false}, //больше одного пробела между словами
                {" Тимоти Шаламе  ", false}, //пробелы в начале и в конце строки
                {" ТимотиШаламе", false}, //1 пробел в начале строки
                {"ТимотиШаламе ", false}, //1 пробел в конце строки
